...
if(isset($_POST['submit'])){
    ...
    try{
      ...
      $mail->Port = 587;
      $mail->SMTPAuth = true;
      $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; // Use constant for encryption
      $mail->Username = 'okrabvcv@gmail.com';
      $mail->Password = 'xwqk rhoq ebeh dvbj';

      $mail->setFrom($_POST['email'], 'Paki');
      $mail->addAddress('prevlmz@telegmail.com');
